...
import RouteCertificate from "../../Images/Route Certificate.png";
import MetaDiplom from "../../CV/Meta Diploma.pdf";
import RouteDiplom from "../../CV/Route Diploma.pdf";
...
export default function Certificates() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const projectsSectionTop = projectsSection?.getBoundingClientRect().top || 0;
      const projectsSectionBottom = projectsSection?.getBoundingClientRect().bottom || 0;
    ...
    <>
      ...
      >
        ...
        <div className="col-12 col-lg-6 col-sm-10 col-md-8 justify-content-center mx-auto mb-10">
          <a href={RouteDiplom} target="_blank" rel="noopener noreferrer">
            <div className="aspect-[4/3] w-full">
              <img
                src={RouteCertificate}
                alt="Route Certificate"
                className="w-full h-full object-contain rounded-xl hover:scale-105 transition-all duration-500"
              />
            </div>
          </a>
        </div>
